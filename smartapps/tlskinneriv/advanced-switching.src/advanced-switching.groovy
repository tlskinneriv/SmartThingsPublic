 ...
 */
definition(
    name: "Advanced Switching",
    namespace: "tlskinneriv",
    author: "Thomas Skinner",
    description: "Advanced triggered switching with pause times for schedules",
    category: "My Apps",
	...
	dynamicPage(name: "page1") {
    	section {
            ...
            if (switchesAction) {
                ...
                def switchesAction_opposite = (switchesAction == "Turn On") ? "off" : "on"
                // get the solar data
                ...
                if (solarSelect && !solarSelect_specificTime && !solarSelect_amountTime) {
                    ...
                    input (name: "solarSelect_opposite", type: "bool", title: "Also turn " + switchesAction_opposite + " at " + solarSelect_opposite_mode + "?",
                ...
                if (solarSelect && !solarSelect_specificTime && !solarSelect_opposite) {
                    input (name: "solarSelect_amountTime", type: "bool", title: "Also turn " + switchesAction_opposite + " after an amount of time?",
                    	required: false, submitOnChange: true)
                ...
                if (solarSelect && !solarSelect_opposite && !solarSelect_amountTime) {
                    input (name: "solarSelect_specificTime", type: "bool", title: "Also turn " + switchesAction_opposite + " at a specific time?",
                    	required: false, submitOnChange: true)
